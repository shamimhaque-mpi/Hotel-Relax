<?php
    class Team extends Admin_Controller{
        ...
        public function index(){
            ...
            $this->load->view('components/team/add', $this->data);
        ...
        public function all_view(){
            ...
            $this->load->view('admin/includes/headermenu', $this->data);
            $this->load->view('admin/includes/nav', $this->data);
            $this->load->view('components/team/list', $this->data);
            $this->load->view('admin/includes/footer', $this->data);
        }
        ...
        public function add_process(){
            ...
            $path  = "backend/images/team/";
            $name  = 'gallery'.(strtotime(date('Y-m-d h:i:s'))*10);
            $size  = '1024';
    
            if(isset($_FILES['img']['name']) && $path = upload_img("img", $types, $size, $path, $name)){
                $data['path'] = $path;
            }
            
            // check existance
            if(exist('teams', (['name'=>$this->input->post('name')]))==false){
                if(save('teams', $data)){
                    set_msg('success', 'success', 'team Successfully Created !');
                }else{
                    set_msg('warning', 'warning', 'team Not Created !');
                }
            }else{
                set_msg('warning', 'warning', 'team Already Exists !');
            }
            redirect_back();
        }
        ...
        public function edit($id=null){
            ...
            $this->data['team'] = read('teams', ['id'=>$id]);
            
            $this->load->view('admin/includes/header', $this->data);
            $this->load->view('admin/includes/aside', $this->data);
            $this->load->view('admin/includes/headermenu', $this->data);
            $this->load->view('admin/includes/nav', $this->data);
            $this->load->view('components/team/edit', $this->data);
            $this->load->view('admin/includes/footer', $this->data);
        }
        ...
        public function edit_process($id=null){
            ...
            // check existance
            /*if(exist('teams', ['id !='=>$id,'name'=>($this->input->post('name'))])){
                set_msg('warning', 'warning', 'This team Already Exists !');
                redirect_back();
            }*/
            ...
            if(update('teams', $data, ['id'=>$id])){
                set_msg('success', 'success', 'team Successfully Update !');
            }else{
                set_msg('warning', 'warning', 'team Not Update !');
            }
            redirect_back();
        }
        ...
        */
        ...
        public function delete($id=null){
            ...
            if(delete('teams', ['id'=>$id])){
                set_msg('success', 'success', 'team Permanently Deleted !');
            }else{
                set_msg('warning', 'warning', 'team Not Deleted !');
            }
            redirect_back();
        }
