    ...
    <div class="row">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <?php msg(); ?>
                <form action="<?php echo get_url("restaurant/restaurant/add_process"); ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label class="col-md-2 control-label">Retaurant Name <span class="req">*</span> </label>
                        <div class="col-md-5">
                    ...
                    <!--<div class="form-group">-->
                    <!--    <label class="col-md-2 control-label">Restaurant Price  <span class="req">*</span></label>-->
                    <!--    <div class="col-md-5">-->
