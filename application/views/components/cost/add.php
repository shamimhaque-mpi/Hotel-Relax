    ...
    <div class="row">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <?php msg(); ?>
                <form action="<?php echo get_url("cost/cost/add_process"); ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <select name="cost_field" class="form-control" required>
                                <option selected disabled>-- Select cost field --</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" name="spend_by" placeholder="spend by" class="form-control" >
                        </div>
                    </div>
