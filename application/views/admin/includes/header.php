...
<head>
    ...
    <title><?php echo $meta_title; ?>  Dashboard </title>
    <!-- favicon -->
    ...
    <link rel="stylesheet" href="<?php echo site_url('private/css/sweetalert2.min.css'); ?>" id="theme-styles">
    <script src="<?php echo site_url('private/js/sweetalert2.min.js'); ?>"></script>
