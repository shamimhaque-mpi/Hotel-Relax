<style>
    ...
    /*.sidebar-nav li.developer{
        background: #d9e1fb;
    }
    
    .sidebar-nav li.developer a{
        color: #333;
    }
    .sidebar-nav li.developer.active a{
        background: #f1f1f1;
    }
    .sidebar-nav li.developer.active>a{
        color: var(--activeColor);
    }
    .sidebar-nav li.developer.active>ul>li.active>a{
        color: var(--activeColor);
    }*/
...
<aside id="sidebar-wrapper">
    <div class="sidebar-nav">
        <h3 class="sidebar-brand <?php if($this->data['width'] == 'full-width') {echo 'sidebar-slide';} ?>">
			<a style="font-size: 23px !important;" href="<?php echo site_url('admin'); ?>">  <span>Panel</span></a>
		</h3>
    </div>
    <nav class="aside-nav">
